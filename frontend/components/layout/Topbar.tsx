...
export function Topbar({
  ...
  const handleLogout = () => {
    // IMPORTANT:
    // The HRMS authentication system stores tokens in cookies.
    Cookies.remove("access_token");
    Cookies.remove("refresh_token");

    // Clear any legacy browser storage too.
    try {
    ...
    // Force navigation to the actual auth route.
  ...
  return (
    ...
    >
      ...
      <div
        className="
          hidden w-[280px] items-center gap-2
      ...
      <div className="ml-2 flex items-center gap-1">
        ...
        <button
          ...
          onClick={() => {
            window.open(
              "mailto:support@enterprise-hrms.local?subject=HR Portal Support",
              "_self"
            );
          }}
          className="
          ...
          {notificationsOpen && (
            <div
              className="
                ...
                bg-white
                p-1.5
                shadow-[0_15px_40px_rgba(15,23,42,.14)]
              "
            >
